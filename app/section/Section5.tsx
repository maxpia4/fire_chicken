...
export const Section5 = () => {
  ...
  return (
    <SectionContainer sectionIdx={5}>
      <div className="relative flex flex-col items-center h-screen px-10" onClick={handleNextStep}>
        {/* 텍스트 영역 */}
        {currentStep < 4 ? (
          <div
            className={twMerge(
          ...
          >
            {currentStep === 0 && (
              <div
                className={twMerge(
                  "relative bg-white text-black text-xl sm:text-2xl md:text-3xl font-bold p-4 rounded-xl shadow-xl cursor-pointer w-max",
                  isFading ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0" // 페이드 애니메이션
                )}
              >
                Ready for the roadmap? Click me!
                {/* 말풍선 꼬리 */}
                <div className="absolute bottom-[-12px] left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[12px] border-r-[12px] border-t-[12px] border-t-white border-l-transparent border-r-transparent" />
              </div>
            )}
            ...
            {currentStep > 0 && (
              <div
                className={twMerge(
                  "lg:w-2/3 p-8 rounded-lg shadow-xl bg-black bg-opacity-70 text-white font-bold transition-all duration-300 ease-in-out",
                  isFading ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0" // 페이드 애니메이션
                )}
              >
                {currentStep === 1 && (
                  <div className="space-y-8">
                    <div className="p-2 rounded-lg shadow-md">
                      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4">Phase 1: Airdrop Events</h2>
                ...
                {currentStep === 2 && (
                  <div className="space-y-8">
                    <div className="p-2 rounded-lg shadow-md">
                      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4">Phase 2: Collaboration and Meme Events</h2>
                      ...
                      <div className="text-xl sm:text-2xl md:text-3xl italic space-y-4">
                ...
                {currentStep === 3 && (
                  <div className="space-y-8">
                    <div className="p-2 rounded-lg shadow-md">
                      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4">Phase 3: Be the King</h2>
                      <p className="text-xl sm:text-2xl md:text-3xl">
                ...
                <button className="mt-4 px-6 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg">
          ...
          <>
            <div
              className={twMerge(
                "bg-white text-black text-xl sm:text-2xl md:text-3xl font-bold p-4 rounded-xl shadow-xl cursor-pointer w-max mt-44",
                isFading ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0" // 페이드 애니메이션
              )}
            >
        ...
        {/* 이미지 영역 */}
        <div className="absolute bottom-20 lg:bottom-0 left-0 w-full flex justify-center">
          <img
