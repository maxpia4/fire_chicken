  ...
  <SectionContainer sectionIdx={2}>
    <div className="flex flex-1 flex-col lg:flex-row items-center justify-center px-10">
      <img
        ...
        alt="Fire Chicken"
      />
      <div className="flex-1 p-8 rounded-lg shadow-xl bg-black bg-opacity-70 text-white font-bold mb-52 lg:mb-0">
        {/* 더 작은 글자 크기 적용 */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6">
          About Firechicken Coin
        </h1>
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">The Birth of Firechicken Coin</h2>
        <p className="text-base sm:text-lg md:text-xl mb-6 leading-relaxed">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">The Beginning of the Meme Coin War</h2>
        <p className="text-base sm:text-lg md:text-xl mb-6 leading-relaxed">
          Firechicken Coin ignites a spicy war against existing meme coins in the cryptocurrency market.
        </p>

        <div className="text-base sm:text-lg md:text-xl italic mb-8">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">Features</h2>
